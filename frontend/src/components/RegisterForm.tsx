    ...
    <div className="flex justify-center items-center min-h-[100vh] bg-gradient-to-br from-[#0a5c85] via-[#1073a3] to-[#064360] p-4 relative overflow-hidden">
      <Card className="max-w-md w-full p-6 shadow-xl border border-teal-900/10 rounded-3xl bg-white/95 backdrop-blur-md">
        <CardHeader className="flex flex-col gap-1.5 items-center px-0 pb-4 border-b border-teal-950/10 text-center">
          <h1 className="text-2xl font-black tracking-tight text-slate-900">Crear Cuenta</h1>
        </CardHeader>
        ...
        <div className="flex flex-col gap-5 py-3">
          ...
          >
            ...
            <form.Field name="name">
              {(field) => (
                <div className="flex flex-col gap-1.5">
                  <label className="text-small font-semibold text-slate-700">Nombre</label>
                  <Input
            ...
            <Button
              type="submit"
              size="lg"
              className="w-full mt-3 font-bold text-white bg-[#1d5b79] hover:bg-[#16475f] 
                shadow-lg shadow-[#1d5b79]/25 rounded-2xl h-12 transition-all duration-200 
            ...
            ¿Tenés cuenta?{' '}
            <a href="/login" className="text-[#1d5b79] font-bold hover:underline">
              Inicia sesión aquí
            </a>
          </div>
